...
//   /* ================= PAYMENT ================= */
// app.post("/api/bookings/create", verifyFirebaseToken, async (req: any, res) => {
//   try {
//     console.log("📦 Booking request:", req.body);
...
//     // 🔐 Get verified Firebase user ID
//     const userId = req.user.uid;

//     // 🧹 Remove any fake user fields from frontend
...
//     const ref = await firestore.collection("bookings").add({
//       ...req.body,
//       userId, // ✅ trusted user ID from token
//       otpCode: otp,
//       status: "pending",
//       paymentStatus: "pending",
//       createdAt: admin.firestore.Timestamp.now(),
...
//       project_id: "arklight-b36a3",
//       private_key_id: "8523b3a9cd63e5e2b93a2487a00d5971c4037305",
//       private_key:
//         "-----BEGIN PRIVATE KEY-----\\nIGeuPdEBFS7nWWLRCEDaifM6\n-----END PRIVATE KEY-----\n",
//       client_email:
//         "firebase-adminsdk-fbsvc@arklight-b36a3.iam.gserviceaccount.com",
//       client_id: "103515964723316578431",
//       auth_uri: "https://accounts.google.com/o/oauth2/auth",
//       token_uri: "https://oauth2.googleapis.com/token",
//       auth_provider_x509_cert_url: "https://www.googleapis.com/oauth2/v1/certs",
//       client_x509_cert_url:
//         "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40arklight-b36a3.iam.gserviceaccount.com",
...
async function startServer() {
  ...
  app.use(
    cors({
      origin: ["https://fixivo.vercel.app", "http://localhost:5173"],
      methods: ["GET", "POST", "PUT", "DELETE", "OPTIONS"],
      credentials: true,
    }),
  );
